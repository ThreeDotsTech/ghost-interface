...
echo "Address 1 DERO balance" $(balance $user1_rpc_port )
echo "Address 2 DERO balance" $(balance $user2_rpc_port )

# use owner wallet to load/install an Ghost sc to chain
ghostscid=$(curl --silent --request POST --data-binary   @ghost_min.bas http://127.0.0.1:$owner_rpc_port/install_sc| jq -r ".txid")
...
echo -n "user 1 minting 20000000000 asset1 "
...
echo -n "user 2 minting 20000000000 asset1 "
...
curl --silent http://127.0.0.1:$user1_rpc_port/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"transfer","params":{"scid":"'"$ghostscid"'","ringsize":2, "sc_rpc":[{"name":"entrypoint","datatype":"S","value":"AddLiquidity"},{"name":"t","datatype":"S","value":"'"$asset1scid"'"},{"name":"u","datatype":"U","value":1}], "transfers": [{"burn":1234,"destination":"'"$user2_address"'"},{"scid":"'"$asset1scid"'", "burn":1234}] }}' -H 'Content-Type: application/json' | jq -r ".result.txid"
sleep 2

echo -n "user 1 doubling liquidity for the asset1 pair"
curl --silent http://127.0.0.1:$user1_rpc_port/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"transfer","params":{"scid":"'"$ghostscid"'","ringsize":2, "sc_rpc":[{"name":"entrypoint","datatype":"S","value":"AddLiquidity"},{"name":"t","datatype":"S","value":"'"$asset1scid"'"},{"name":"u","datatype":"U","value":1}], "transfers": [{"burn":1234,"destination":"'"$user2_address"'"},{"scid":"'"$asset1scid"'", "burn":5000}] }}' -H 'Content-Type: application/json' | jq -r ".result.txid"
sleep 2

echo -n "user 2 adding liquidity for the asset1 pair"
curl --silent http://127.0.0.1:$user2_rpc_port/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"transfer","params":{"scid":"'"$ghostscid"'","ringsize":2, "sc_rpc":[{"name":"entrypoint","datatype":"S","value":"AddLiquidity"},{"name":"t","datatype":"S","value":"'"$asset1scid"'"},{"name":"u","datatype":"U","value":1}], "transfers": [{"burn":1234,"destination":"'"$user1_address"'"},{"scid":"'"$asset1scid"'", "burn":5000}] }}' -H 'Content-Type: application/json' | jq -r ".result.txid"
sleep 2

echo -n "user 1 removing all liquidity for the asset1 pair"
curl --silent http://127.0.0.1:$user1_rpc_port/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"scinvoke","params":{"scid":"'"$ghostscid"'","ringsize":2, "sc_rpc":[{"name":"entrypoint","datatype":"S","value":"RemoveLiquidity"},{"name":"t","datatype":"S","value":"'"$asset1scid"'"},{"name":"v","datatype":"U","value":2468},{"name":"w","datatype":"U","value":1},{"name":"y2","datatype":"U","value":1}] }}' -H 'Content-Type: application/json' | jq -r ".result.txid"
sleep 2
...
curl --silent http://127.0.0.1:$user1_rpc_port/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"transfer","params":{"scid":"'"$ghostscid"'","ringsize":2, "sc_rpc":[{"name":"entrypoint","datatype":"S","value":"AddLiquidity"},{"name":"t","datatype":"S","value":"'"$asset1scid"'"},{"name":"u","datatype":"U","value":1}], "transfers": [{"burn":10000,"destination":"'"$user2_address"'"},{"scid":"'"$asset1scid"'", "burn":10000}] }}' -H 'Content-Type: application/json' | jq -r ".result.txid"
sleep 2
curl --silent http://127.0.0.1:$user2_rpc_port/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"transfer","params":{"scid":"'"$ghostscid"'","ringsize":2, "sc_rpc":[{"name":"entrypoint","datatype":"S","value":"AddLiquidity"},{"name":"t","datatype":"S","value":"'"$asset1scid"'"},{"name":"u","datatype":"U","value":1}], "transfers": [{"burn":1234,"destination":"'"$user1_address"'"},{"scid":"'"$asset1scid"'", "burn":5000}] }}' -H 'Content-Type: application/json' | jq -r ".result.txid"
sleep 2

echo -n "user 1 minting 20000000000 asset2 "
...
echo -n "user 2 minting 20000000000 asset2 "
...
curl --silent http://127.0.0.1:$user1_rpc_port/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"transfer","params":{"scid":"'"$ghostscid"'","ringsize":2, "sc_rpc":[{"name":"entrypoint","datatype":"S","value":"AddLiquidity"},{"name":"t","datatype":"S","value":"'"$asset2scid"'"},{"name":"u","datatype":"U","value":1}], "transfers": [{"burn":10000,"destination":"'"$user2_address"'"},{"scid":"'"$asset2scid"'", "burn":10000}] }}' -H 'Content-Type: application/json' | jq -r ".result.txid"
sleep 2
curl --silent http://127.0.0.1:$user2_rpc_port/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"transfer","params":{"scid":"'"$ghostscid"'","ringsize":2, "sc_rpc":[{"name":"entrypoint","datatype":"S","value":"AddLiquidity"},{"name":"t","datatype":"S","value":"'"$asset2scid"'"},{"name":"u","datatype":"U","value":1}], "transfers": [{"burn":1234,"destination":"'"$user1_address"'"},{"scid":"'"$asset2scid"'", "burn":5000}] }}' -H 'Content-Type: application/json' | jq -r ".result.txid"
sleep 2
...
curl --silent http://127.0.0.1:$user1_rpc_port/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"scinvoke","params":{"sc_dero_deposit":1000,"scid":"'"$ghostscid"'","ringsize":2, "sc_rpc":[{"name":"entrypoint","datatype":"S","value":"DeroToAssetSwapInputMin"},{"name":"min_assets","datatype":"U","value":400},{"name":"asset_address","datatype":"S","value":"'"$asset2scid"'"}] }}' -H 'Content-Type: application/json' | jq -r ".result.txid"
sleep 2

echo -n "Fails when user 1 buys 100 asset2 and pays more dero than the max specified"
curl --silent http://127.0.0.1:$user1_rpc_port/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"scinvoke","params":{"sc_dero_deposit":266,"scid":"'"$ghostscid"'","ringsize":2, "sc_rpc":[{"name":"entrypoint","datatype":"S","value":"DeroToAssetSwapOutput"},{"name":"assets_bought","datatype":"U","value":100},{"name":"asset_address","datatype":"S","value":"'"$asset2scid"'"}] }}' -H 'Content-Type: application/json' | jq -r ".result.txid"
sleep 2
...
curl --silent http://127.0.0.1:$user2_rpc_port/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"transfer","params":{"scid":"'"$ghostscid"'","ringsize":2, "sc_rpc":[{"name":"entrypoint","datatype":"S","value":"AssetToDeroSwapOutput"},{"name":"dero_bought","datatype":"U","value":100},{"name":"asset_address","datatype":"S","value":"'"$asset2scid"'"}], "transfers": [{"scid":"'"$asset2scid"'", "burn":37}] }}' -H 'Content-Type: application/json' | jq -r ".result.txid"
sleep 2
...
echo -n "user 1 removing all liquidity for the asset2 pair"
