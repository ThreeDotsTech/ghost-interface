...
ghostscid=$(curl --silent --request POST --data-binary   @ghost_new.bas http://127.0.0.1:$owner_rpc_port/install_sc| jq -r ".txid")
...
echo -n "user 1 removing all liquidity for the asset1 pair"
curl --silent http://127.0.0.1:$user1_rpc_port/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"scinvoke","params":{"scid":"'"$ghostscid"'","ringsize":2, "sc_rpc":[{"name":"entrypoint","datatype":"S","value":"RemoveLiquidity"},{"name":"asset_address","datatype":"S","value":"'"$asset1scid"'"},{"name":"amount","datatype":"U","value":10000},{"name":"min_dero","datatype":"U","value":1},{"name":"min_assets","datatype":"U","value":1}] }}' -H 'Content-Type: application/json' | jq -r ".result.txid"
sleep 2

echo -n "user 1 removing all liquidity for the asset2 pair"
curl --silent http://127.0.0.1:$user1_rpc_port/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"scinvoke","params":{"scid":"'"$ghostscid"'","ringsize":2, "sc_rpc":[{"name":"entrypoint","datatype":"S","value":"RemoveLiquidity"},{"name":"asset_address","datatype":"S","value":"'"$asset2scid"'"},{"name":"amount","datatype":"U","value":10000},{"name":"min_dero","datatype":"U","value":1},{"name":"min_assets","datatype":"U","value":1}] }}' -H 'Content-Type: application/json' | jq -r ".result.txid"
sleep 2
...
echo -n "user 2 removing all liquidity for the asset1 pair"
curl --silent http://127.0.0.1:$user2_rpc_port/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"scinvoke","params":{"scid":"'"$ghostscid"'","ringsize":2, "sc_rpc":[{"name":"entrypoint","datatype":"S","value":"RemoveLiquidity"},{"name":"asset_address","datatype":"S","value":"'"$asset2scid"'"},{"name":"amount","datatype":"U","value":1234},{"name":"min_dero","datatype":"U","value":1},{"name":"min_assets","datatype":"U","value":1}] }}' -H 'Content-Type: application/json' | jq -r ".result.txid"
sleep 2
